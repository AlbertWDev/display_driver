...
#define DISP_CMD_MADCTL     0x36
    ...
    #define MADCTL_PORTRAIT MADCTL_MX
    #define MADCTL_LANDSCAPE MADCTL_MV
    #define MADCTL_PORTRAIT_FLIP MADCTL_MY
    #define MADCTL_LANDSCAPE_FLIP MADCTL_MV | MADCTL_MX | MADCTL_MY
...
#define DISP_CMD_WRAMCONT   0x3C
// Read Memory Continue
#define DISP_CMD_RDRAMCONT  0x3E
